...
Hinweis: Verwenden Sie ``r config$sched$flag$time``.

::::::::::::::: solution

## Lösung

Die folgende Zeile teilt `r config$sched$name` mit, dass unser Auftrag innerhalb von 2 Minuten beendet sein soll:
