...
Wenn Sie dazu aufgefordert werden, geben Sie ein sicheres Passwort ein, das die [obigen Überlegungen berücksichtigt](#überlegungen-zu-ssh-schlüsselpasswörtern)
...
beachten Sie dabei die [oben genannten Überlegungen](#überlegungen-zu-ssh-schlüsselpasswörtern).
